...
gam_lasso <- gam(lasso_formula, data = data_rf_clean, family = poisson(link = "log"))
...
gam_ridge <- gam(ridge_formula, data = data_rf_clean, family = poisson(link = "log"))
